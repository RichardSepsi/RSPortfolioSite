if(currentlang == "EN") {
    ...
    Realizmus na Orave is a simple audioguide progressive web app made to guide you throught most of the major sights from the time of Realism in
    ...
    document.getElementById("langs-realizmusnaorave-myworktext").innerHTML = `I worked on the design of the app ui, the download screen and various other parts of the app and icons.`
    document.getElementById("langs-realizmusnaorave-softewaretitle").innerHTML = `Software used`
    document.getElementById("langs-realizmusnaorave-label1").innerHTML = `App UI`
    ...
    document.getElementById("langs-realizmusnaorave-abouttext").innerHTML = `
    Realizmus na Orave je jednoduchá progresívna webová aplikácia, ktorá vás dokáže sprevádzať cez významné pamiatky z času obdobia Realizmu v
    Oravskom regióne Slovenska.
    <div style="height: 12px;"></div>
    Projekt/aplikácia nie je momentálne dostupná, pretože nikdy nebola verejne vydaná. Avšak, väčšina funkcionality aplikácie bola dokončená a pripravená na použitie.`
    document.getElementById("langs-realizmusnaorave-myworktitle").innerHTML = `Moja práca na projekte`
    document.getElementById("langs-realizmusnaorave-myworktext").innerHTML = `Ja som pracoval na designe aplikácie, úvodnej obrazovke, iných častiach aplikácie a na ikonách.`
