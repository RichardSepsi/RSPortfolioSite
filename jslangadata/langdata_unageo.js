if(currentlang == "EN") {
    ...
    font, ktorý používa geometrické tvary a rovnomernú šírku tam keď je to možné, ale stále si zachováva dobrú čitatelnosť.<br>`
    document.getElementById("langs-unageo-desc2").innerHTML = `Unageo podporuje stovky jazykov v latinskej a gréckej abecede, a aj v cyrilike.`
    ...
    document.getElementById("langs-unageo-greek").innerHTML = `Řecké Unageo se drží stejného stylu s dokonalými tvary,
