if(currentlang == "EN") {
    document.getElementById("langs-seasidecliffs-time").innerHTML = `From November 2023 to October 2024`
    ...
    document.getElementById("langs-seasidecliffs-date").innerHTML = `Date added:<span class="project-element-subtext" style="margin-left: 10px;">30.10.2024</span>`
    ...
    document.getElementById("langs-seasidecliffs-time").innerHTML = `Od Novembra 2023 do Októbra 2024`
    ...
    document.getElementById("langs-seasidecliffs-time").innerHTML = `Od Listopadu 2023 do Října 2024`
    ...
    document.getElementById("langs-seasidecliffs-date").innerHTML = `Datum přidání:<span class="project-element-subtext" style="margin-left: 10px;">30.10.2024</span>`
