if(currentlang == "EN") {
    ...
    It's a project that I primarily made for my personal use, however, you can also download it from GitHub and use it freely if you want.`
    ...
    Projekt som vytvoril hlavne pre svoje vlastné použitie, ale ak by ste mali záujem, môžete si ho stiahnuť z Githubu a volne používať.`
    ...
    Projekt jsem vytvořil hlavně pro vlastní použití, ale pokud byste měli zájem, můžete si ho stáhnout z Githubu a volně používat.`
    document.getElementById("langs-wordgrind-softewaretitle").innerHTML = `Použitý software`
    document.getElementById("langs-wordgrind-link").innerHTML = `Get WordGrind on <u>GitHub</u>`
}
